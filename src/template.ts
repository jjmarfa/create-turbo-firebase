...
import { getTemplateDir, logSuccess, logError } from './utils.js';
...
export async function copyTemplate(config: ProjectConfig): Promise<void> {
 ...
 */
function replacePackageScopes(obj: any, projectName: string): any {
